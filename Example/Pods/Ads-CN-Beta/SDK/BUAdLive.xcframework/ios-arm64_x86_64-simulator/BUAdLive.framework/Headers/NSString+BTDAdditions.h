...
typedef NS_ENUM(SInt32, PBUBTDURLParameterEncodeStrategy) {
    /**
     Default.
     ...
     */
    PBUBTDURLParameterEncodeStrategyDefault,
     ...
     */
    PBUBTDURLParameterEncodeStrategyEncodeByNSURLComponents,
     ...
     */
    PBUBTDURLParameterEncodeStrategyNoEncode,
     ...
     */
    PBUBTDURLParameterEncodeStrategyEncode,
    
    /**
     All parameters will be decoded first and then encoded by btd_stringByURLEncode.
     Different From PBUBTDURLParameterEncodeStrategyEncode, if the original string has URL query that not be URL-encoded completely, the URL‘s query characters which after the first '=' and before the next '&' are removed, and the rest of URL will be encoded.
     ❌
     ...
     */
    PBUBTDURLParameterEncodeStrategyFullyEncode,
};
...
@property(nonatomic, assign, class) PBUBTDURLParameterEncodeStrategy btd_stringURLParamsEncodeStrategy;
 ...
 */
+ (nonnull NSString *)pbu_btd_stringWithUUID;
+ (nonnull NSString *)pbu_btd_HMACMD5WithKey:(nonnull NSString *)key andData:(nullable NSString *)data;
/**
 Return a hex NSString in UTF-16 code unit.
 */
- (nonnull NSString *)pbu_btd_hexString;

/**
 Return a NSString encoded according to base64.
 */
- (nullable NSString *)pbu_btd_base64EncodedString;

/**
 Return a NSString decoded according to base64.
 */
- (nullable NSString *)pbu_btd_base64DecodedString;
...
/**
 ...
 resultStr:ABC
 */
- (nullable NSString *)pbu_btd_stringByRemoveAllCharactersInSet:(nonnull NSCharacterSet *)characterSet;
/**

 @return Return a NSString after removing all whitespace and newline characters.
 */
- (nullable NSString *)pbu_btd_stringByRemoveAllWhitespaceAndNewlineCharacters;

#if TARGET_OS_IPHONE
/**
 Calculate the size of the text.
 */
- (CGFloat)pbu_btd_heightWithFont:(nonnull UIFont *)font width:(CGFloat)maxWidth;

- (CGFloat)pbu_btd_widthWithFont:(nonnull UIFont *)font height:(CGFloat)maxHeight;

- (CGSize)pbu_btd_sizeWithFont:(nonnull UIFont *)font width:(CGFloat)maxWidth;

- (CGSize)pbu_btd_sizeWithFont:(nonnull UIFont *)font width:(CGFloat)maxWidth maxLine:(NSInteger)maxLine;
#else
- (CGFloat)pbu_btd_heightWithFont:(nonnull NSFont *)font width:(CGFloat)maxWidth;

- (CGFloat)pbu_btd_widthWithFont:(nonnull NSFont *)font height:(CGFloat)maxHeight;

- (CGSize)pbu_btd_sizeWithFont:(nonnull NSFont *)font width:(CGFloat)maxWidth;

- (CGSize)pbu_btd_sizeWithFont:(nonnull NSFont *)font width:(CGFloat)maxWidth maxLine:(NSInteger)maxLine;
#endif
 ...
 */
- (BOOL)pbu_btd_matchsRegex:(nonnull NSString *)regex;
 ...
 */
- (void)pbu_btd_enumerateRegexMatches:(nonnull NSString *)regex options:(NSRegularExpressionOptions)options usingBlock:(nonnull void (^)(NSString *_Nullable match, NSRange matchRange, BOOL * _Nullable stop))block;
/**
 ...
 */
- (nullable NSNumber *)pbu_btd_numberValue;
/**
 ...
 */
- (nullable NSString *)pbu_btd_urlStringByAddingComponentString:(nonnull NSString *)componentString;
/**
 ...
 @return A NSString.
 */
- (nullable NSString *)pbu_btd_urlStringByAddingComponentArray:(NSArray<NSString *> *)componentArray;
...
/**
 ...
 The method is control by btd_stringURLParamsEncodeStrategy which is defined above. The default global strategy is PBUBTDURLParameterEncodeStrategyDefault. You can set btd_stringURLParamsEncodeStrategy to change the global policy when the application startup.
 ...
 */
- (nullable NSString *)pbu_btd_urlStringByAddingParameters:(NSDictionary<NSString *, NSString *> *)parameters;
- (nullable NSString *)pbu_btd_urlStringByAddingParameters:(NSDictionary<NSString *,NSString *> *)parameters strategy:(PBUBTDURLParameterEncodeStrategy)strategy;
...
/**
 ...
 @return A NSString.
 */
- (nullable NSString *)pbu_btd_urlStringByAddingParameters:(NSDictionary<NSString *, NSString *> *)parameters fullyEncoded:(BOOL)fullyEncoded DEPRECATED_MSG_ATTRIBUTE("Use btd_urlStringByAddingParameters:strategy: instead. If fullyEncoded = YES, use strategy PBUBTDURLParameterEncodeStrategyFullyEncode, otherwise use strategy PBUBTDURLParameterEncodeStrategyDefault.");
 ...
 */
- (nullable NSString *)pbu_btd_urlStringByRemovingParameters:(NSArray<NSString *> *)parameters;
- (nullable NSString *)pbu_btd_urlStringByRemovingParameters:(NSArray<NSString *> *)parameters strategy:(PBUBTDURLParameterEncodeStrategy)strategy;
...
/**
 ...
 @return A NSString.
 */
- (nullable NSString *)pbu_btd_urlStringByRemovingParameters:(NSArray<NSString *> * _Nonnull)parameters fullyEncoded:(BOOL)fullyEncoded DEPRECATED_MSG_ATTRIBUTE("Use btd_urlStringByRemovingParameters:strategy: instead. If fullyEncoded = YES, use strategy PBUBTDURLParameterEncodeStrategyFullyEncode, otherwise use strategy PBUBTDURLParameterEncodeStrategyDefault.");
 ...
 */
- (nullable NSURLComponents *)pbu_btd_URLComponents;

/**
 @return Return A NSArray consists of path strings.If there is no path string, return nil.
 */
- (nullable NSArray<NSString *> *)pbu_btd_pathComponentArray;
/**
 ...
 */
- (nullable NSDictionary<NSString *, NSString *> *)pbu_btd_queryParamDict;
/**
 Return a decoded query param dictionary.
 
 @return A NSDictionary.
 */
- (nullable NSDictionary<NSString *, NSString *> *)pbu_btd_queryParamDictDecoded;

/**

 @return Return the scheme. If the string is a empty string, return nil.
 */
- (nullable NSString *)pbu_btd_scheme;
/**
 
 @return Return the path.If there's no path, return nil.
 */
- (nullable NSString *)pbu_btd_path;
 ...
 */
- (NSString *)pbu_btd_prependingLibraryPath;
...
/**
 ...
 @return The string after prepending.
 */
- (NSString *)pbu_btd_prependingCachePath;
...
/**
 ...
 @return The string after prepending.
 */
- (NSString *)pbu_btd_prependingDocumentsPath;
...
/**
 ...
 @return The string after prepending.
 */
- (NSString *)pbu_btd_prependingTemporaryPath;
 ...
 */
- (NSRange)pbu_btd_rangeOfString:(NSString *)searchString options:(NSStringCompareOptions)mask range:(NSRange)rangeOfReceiverToSearch;
...
/**
 ...
 @return The range of the searchString within the receiver string.
 */
- (NSRange)pbu_btd_rangeOfString:(NSString *)searchString options:(NSStringCompareOptions)mask range:(NSRange)rangeOfReceiverToSearch locale:(nullable NSLocale *)locale API_AVAILABLE(macos(10.5), ios(2.0), watchos(2.0), tvos(9.0));
 ...
 */
- (CGFloat)pbu_btd_heightWithWidth:(CGFloat)maxWidth;
