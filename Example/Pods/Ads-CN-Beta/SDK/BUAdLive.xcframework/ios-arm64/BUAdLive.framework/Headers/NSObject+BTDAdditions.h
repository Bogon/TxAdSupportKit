 ...
 */
- (nullable id)pbu_btd_performSelectorWithArgs:(nonnull SEL)sel, ...;

/// Similiar to `btd_performSelectorWithArgs:`, but with a CVAList to make Swift compatible
/// @param sel The selector.
/// @param args The args.
- (nullable id)pbu_btd_performSelector:(nonnull SEL)sel withArgs:(va_list)args;
 ...
 */
- (void)pbu_btd_performSelectorWithArgs:(nonnull SEL)sel afterDelay:(NSTimeInterval)delay, ...;

/// Similiar to `btd_performSelectorWithArgs:afterDelay:`, but with a CVAList to make Swift compatible
/// @param sel The selector.
/// @param delay The delay time (second).
/// @param args The args.
- (void)pbu_btd_performSelector:(nonnull SEL)sel afterDelay:(NSTimeInterval)delay withArgs:(va_list)args;
 ...
 */
- (nullable id)pbu_btd_performSelectorWithArgsOnMainThread:(nonnull SEL)sel waitUntilDone:(BOOL)wait, ...;
...
/// @param wait If wait is YES, the method will wait until the job in the main thread is over. Otherwise, the method will not wait.
/// @param args The args.
- (nullable id)pbu_btd_performSelectorOnMainThread:(nonnull SEL)sel waitUntilDone:(BOOL)wait withArgs:(va_list)args;
...
/**
 ...
 @return The result from the selector.
 */
- (nullable id)pbu_btd_performSelectorWithArgs:(nonnull SEL)sel onThread:(nonnull NSThread *)thread waitUntilDone:(BOOL)wait, ...;
...
/// @param wait If wait is YES, the method will wait until the job in the main thread is over. Otherwise, the method will not wait.
/// @param args The args.
- (nullable id)pbu_btd_performSelector:(nonnull SEL)sel onThread:(nonnull NSThread *)thread waitUntilDone:(BOOL)wait withArgs:(va_list)args;
...
/**
 ...
 @param ... The variadic parameter list. The param type should be same with the  corresponding type defined in the selector. Otherwise some errors may happen.
 */
- (void)pbu_btd_performSelectorWithArgsInBackground:(nonnull SEL)sel, ...;

/// Similiar to `btd_performSelectorWithArgsInBackground:`, but with a CVAList to make Swift compatible
/// @param sel The selector.
/// @param args The args.
- (void)pbu_btd_performSelectorInBackground:(nonnull SEL)sel withArgs:(va_list)args;
...
+ (void)pbu_btd_performAllSubclassSelector:(SEL)selector;
 ...
 */
+ (BOOL)pbu_btd_swizzleInstanceMethod:(nonnull SEL)origSelector with:(nonnull SEL)newSelector;
...
/**
 ...
 @return Return YES if selectors were swizzled successfully.
 */
+ (BOOL)pbu_btd_swizzleClassMethod:(nonnull SEL)origSelector with:(nonnull SEL)newSelector;

/**
 Return the class name.
 */
- (nonnull NSString *)pbu_btd_className;
+ (nonnull NSString *)pbu_btd_className;
 ...
 */
- (nullable id)pbu_btd_safeJsonObject;
...
- (void)pbu_btd_attachObject:(nullable id)obj forKey:(NSString *)key;
- (nullable id)pbu_btd_getAttachedObjectForKey:(NSString *)key;

- (void)pbu_btd_attachObject:(nullable id)obj forKey:(NSString *)key isWeak:(BOOL)bWeak;
- (nullable id)pbu_btd_getAttachedObjectForKey:(NSString *)key isWeak:(BOOL)bWeak;
 ...
 */
- (void)pbu_btd_executeOnce:(dispatch_block_t)block;
